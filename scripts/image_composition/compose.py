...
if (__name__ == '__main__'):
    ...
    uber_dirs = ["uber_astronaut", "uber_bender", "uber_black_mage", "uber_blackhat", "uber_demon", "uber_human", "uber_minecraft", "uber_minion", "uber_shark", "uber_stig", "uber_ness", "uber_corrinsan"]
