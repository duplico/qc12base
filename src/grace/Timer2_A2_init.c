 ...
 */
void Timer2_A2_graceInit(void)
{
    /* Struct to pass to Timer_A_initUpMode */
    Timer_A_initUpModeParam initUpParam = {0};

    /* USER CODE START (section: Timer2_A2_graceInit_prologue) */
    /* User initialization code */
    /* USER CODE END (section: Timer2_A2_graceInit_prologue) */

    /* Initialize TimerA in up mode */
    initUpParam.clockSource = TIMER_A_CLOCKSOURCE_ACLK;
    initUpParam.clockSourceDivider = TIMER_A_CLOCKSOURCE_DIVIDER_1;
    initUpParam.timerPeriod = 1048;
    ...
    /* USER CODE START (section: Timer2_A2_graceInit_epilogue) */
    /* User code */
    /* USER CODE END (section: Timer2_A2_graceInit_epilogue) */
}
