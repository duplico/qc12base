...
void EUSCI_B0_graceInit(void)
{
    ...
    EUSCI_B_SPI_masterInit(EUSCI_B0_BASE, EUSCI_B_SPI_CLOCKSOURCE_SMCLK, 4000000, 500000,
                    EUSCI_B_SPI_MSB_FIRST, EUSCI_B_SPI_PHASE_DATA_CAPTURED_ONFIRST_CHANGED_ON_NEXT, EUSCI_B_SPI_CLOCKPOLARITY_INACTIVITY_LOW, EUSCI_B_SPI_4PIN_UCxSTE_ACTIVE_HIGH);
